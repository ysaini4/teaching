...
function getTeacherUserDetails($row) {
	...
	*/
	...
	$jsoninfo=str2json($row['jsoninfo']);
	$details=Fun::getflds(array("tid", "iit", "iitentryyear", "degree", "experience", "addinfo", "youtubelink", "city", "country", "state", "zipcode", "linkprofile", "feedback", "isselected", "rate"),$row);
	mergeifunset($details, Fun::getflds(array("college","subother","minfees","resume", "calvarification", "degree", "degreeother", "branch", "city", "zipcode", "state", "country", "linkprofile", "feedback", "knowaboutusother", ""), $jsoninfo));
