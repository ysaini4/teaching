            ...
            <form class="col s12 l10 offset-l1" enctype="multipart/form-data"  method="post" onsubmit='return submitForm(this);'  >
              ...
              <div class="row">
                ...
                <div class="col s12 l8">
                  <select data-condition="simple" name="minfees" >
                    <option value="" disabled selected>Minimum Fees</option>
              ...
              <div class="row">
                ...
                <div class="col s12 l8">
                  <div class="file-field input-field">
                    <input class="file-path validate" type="text"  data-condition="simple">
                    <div class="btn">
                      <span>Open</span>
              ...
              <div class="row">
                ...
                <div class="col s12 l8">
                    ...
                    <input placeholder="e.g. 9876543210" type="tel" class="validate" name="phone"  length="10" data-condition="phone">
