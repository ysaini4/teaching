   ...
   <div style="height:0px;overflow:hidden">
    ...
    <div class="col s12 l12">
      ...
      <ul class="tabs teal-text text-lighten-1 ">
        <li class="tab col s2"><a id="profiletab1" class=" teal-text text-lighten-1" href="#test1">Profile</a></li>
        <li class="tab col s2 "><a  id="profiletab2" class=" teal-text text-lighten-1" href="#test2">Calender</a></li>
        <li class="tab col s2"><a  id="profiletab3" class=" teal-text text-lighten-1" href="#test3">Topic</a></li>
      <?php
        if($tid==User::loginId()){
      ?>
        <li class="tab col s2"><a id="profiletab4" class="teal-text text-lighten-1" href="#test4">My Classes</a></li>     
      <?php
        }
      ?>
        <li class="tab col s2"><a id="profiletab5" class="teal-text text-lighten-1" href="#test5">My Account</a></li>
      </ul>
    </div>
    </div>
