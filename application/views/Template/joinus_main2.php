 ...
 <div class="row">
  <div class="col s12">
   ...
   <div class="row">
    ...
    <div class="col s12 l4">
     <input placeholder="First Name" type="text" class="validate" name="fname" data-condition="simple" length="30" value="Rahul"  />
    </div>
    <div class="col s12 l4">
   ...
   <div class="row">
    ...
    <div class="col s6 l4">
     <input placeholder="98xxxxxxxx" type="tel" class="validate" id="phonenumber" name="phone" data-condition="phone" pattern="[0-9]*.{10,}" title="Must contain numbers only" value="9854785487"  >
    </div>
   </div>
   <div class="row">
    <div class="col s12 l4">
   ...
   <div class="row">
    ...
    <div class="col s12 l4">
     <input type="date" class="datepicker" name="dob" data-condition="simple" onchange="ageToTime(this)" id="dob_datepicker" value="6 July ,1991" />
    </div>
   </div>
   <div class="row">
    <div class="col s12 l4">
   ...
   <div class="row">
    ...
    <div class="col s12 l4">
     ...
     <div>
      <input placeholder="Postal/Zip Code" type="text" class="validate" name="zipcode" data-condition="simple" value="321123" />
     </div>
    </div>
    <div class="col s12 l4">
     <div>
